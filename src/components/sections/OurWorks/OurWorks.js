  ...
  return(
    <section className="our_works content_max_width" id="our-works">
      ...
      <div className="our_works_title-wrapper">
        ...
        {data?.contentfulOurWorks.cta && <button onClick={() => window.location.href = `${window.location.origin}/projects`} className="our_works_btn">{data?.contentfulOurWorks.cta}</button>}
      </div>
